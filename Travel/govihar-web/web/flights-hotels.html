...
<html>
<head>
<title>Govihar a Travel Agency Category Flat bootstrap Responsive website Template | Flights-hotels :: w3layouts</title>
<!-- Custom Theme files -->
			...
			<div class="nav-top">
				<div class="top-nav">
					...
					<ul class="nav1">
						...
						<li class="active"><a href="flights-hotels.html">Flight+Hotel</a></li>
