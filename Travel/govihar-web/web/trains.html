...
<html>
<head>
<title>Govihar a Travel Agency Category Flat bootstrap Responsive website Template | Train :: w3layouts</title>
<!-- Custom Theme files -->
			...
			<div class="nav-top">
				<div class="top-nav">
					...
					<ul class="nav1">
						...
						<li class="active"><a href="trains.html">Trains</a></li>
															...
															<div class="booking_room">
																...
																<div class="reservation">
																	<ul>	
																		...
																		<li class="span1_of_1 left t-men">
																			 <h5>Senior men (60+)</h5>
																			 <!----------start section_room----------->
																			 <div class="section_room">
																				  <select id="country" onchange="change_country(this.value)" class="frm-field required">
																		...
																		<li class="span1_of_1 t-women">
																			 <h5>Senior women (58+)</h5>
																			 <!----------start section_room----------->
																			 <div class="section_room">
																				  <select id="country" onchange="change_country(this.value)" class="frm-field required">
																						<option value="null">1</option>
