...
<html>
<head>
<title>Green Wheels a Travel Category Flat Bootstrap Responsive Website Template | Travels :: w3layouts</title>
					...
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
							<li><a href="about.html">About</a></li>
								...
								<li class="active"><a href="travels.html">Travels</a></li>
...
<div class="travel">
	<div class="container">
		...
		<p>A/C Multi-Axle Semisleeper, A/C Sleeper, Non A/C Seater & Sleeper bus types operated by this travel operator. Now book online bus tickets at  Check the amenities provided such as blanket, water, video which can vary by routes before booking tickets.customers can book tickets with debit card, credit card and net banking. Book tickets and enjoy the benefits of m-ticket.</p>
			<div class="tra-top">
				<h4>New Orleans Charter : Bus routes and timings</h4>
					...
					<ul class="rou-secnd animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp;">
						<li class="rou">
							...
							<h6><a href="#">California-Alabama</a></h6>
						</li>
						<li class="ser">
							<p>15 Buses</p>
						</li>
					...
					<ul class="rou-secnd animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp;">
						<li class="rou">
							<p>Chicago Charter</p>
							<h6><a href="#">Arkansas-Florida</a></h6>
						</li>
						<li class="ser">
							<p>11 Buses</p>
						</li>
					...
					<ul class="rou-secnd animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp;">
						<li class="rou">
							<p>Houston Charter</p>
							<h6><a href="#">Indiana-Illinois</a></h6>
						</li>
						<li class="ser">
							<p>16 Buses</p>
						</li>
					...
					<ul class="rou-secnd animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp;">
						<li class="rou">
							<p>Orlando Charter</p>
							<h6><a href="#">Delaware-Arizona</a></h6>
						</li>
						<li class="ser">
							<p>13 Buses</p>
						</li>
					...
					<ul class="rou-secnd animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp;">
						<li class="rou">
							<p>Washington Charter</p>
							<h6><a href="#">Kansas-Georgia</a></h6>
						</li>
						<li class="ser">
							<p>12 Buses</p>
						</li>
					...
					<ul class="rou-secnd animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp;">
						<li class="rou">
							<p>Charlotte Charter</p>
							<h6><a href="#">Charlotte Charter</a></h6>
						</li>
						<li class="ser">
							<p>15 Buses</p>
						</li>
