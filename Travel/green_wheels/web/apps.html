...
<html>
<head>
<title>Green Wheels a Travel Category Flat Bootstrap Responsive Website Template | Apps :: w3layouts</title>
...
<div class="apps">
	<div class="container">
		<div class="mobile-app">
					<div class="col-md-5 app-left wow fadeInLeft animated" data-wow-delay=".5s">
						<img src="images/app.png" class="img-responsive" alt="">
					</div>
					<div class="col-md-7 app-right wow fadeInRight animated" data-wow-delay=".5s">
					 
						<h3>Lorem Ipsum available <span>Easiest</span> but the majority have suffered alteration</h3>
			...
			<div class="banner-bottom">
				<div class="banner-text wow zoomIn animated animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">
					<h3>Services</h3>
				...
				<div class="banner-bottom-grids">
					<div class="col-md-4 banner-bottom-grid  wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
					...
					<div class="col-md-4 banner-bottom-grid red  wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
						<div class="services-icon">
					...
					<div class="col-md-4 banner-bottom-grid green  wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
						<div class="services-icon">
							<span class="glyphicon glyphicon-th-large glyphicon-refresh" aria-hidden="true"></span>
						</div>
