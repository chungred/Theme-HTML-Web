...
<html>
<head>
<title>Jewelex a Fashion Category Flat Bootstrap Responsive Web Template| 404 :: w3layouts</title>
					 ...
					 <div class="logo two">
						...
						<div class="navigation">
							<ul class="navig">
								...
								<li class="active"><a href="404.html"><i class="settings"></i><p class="active">Services</p><div class="clearfix"></div></a></li>
