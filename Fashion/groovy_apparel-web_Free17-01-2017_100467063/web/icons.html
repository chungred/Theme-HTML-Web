...
<title>Groovy Apparel a E-Commerce & Fashion Category Bootstrap Responsive Website Template | Icons :: W3layouts</title>
...
<body>
	...
	<!-- Icons -->
	<div class="icons aitsiconswthree main-grid-border">
		<div class="container">

			<div class="grid_3 aitsfontawesomeicons grid_4">
						<div class="icons">
							<h1 class="agileits-icons-title">FONT AWESOME ICONS</h1>
								<section id="new">
					...
					<div class="grid_3 aitsglyphicons grid_4">
						<h2 class="agileits-icons-title">Bootstrap Glyphicons</h2>
